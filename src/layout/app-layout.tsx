...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Contracts', path: '/contracts', entity: 'contract', service: AccessServiceEnum.PROJECT, icon: FiBox },
    { name: 'Jobs', path: '/jobs', entity: 'job', service: AccessServiceEnum.PROJECT, icon: FiBox },
    { name: 'Projects', path: '/projects', entity: 'project', service: AccessServiceEnum.PROJECT, icon: FiBox },
    { name: 'Proposals', path: '/proposals', entity: 'proposal', service: AccessServiceEnum.PROJECT, icon: FiBox },
