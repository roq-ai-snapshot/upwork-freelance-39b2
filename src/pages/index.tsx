...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`Upwork freelancer site`}</title>

        <meta
          name="description"
          content="Upwork freelancer site: Your gateway to global opportunities. Connect, collaborate, and succeed with the world's top freelancers."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Upwork freelancer site: Your gateway to global opportunities. Connect, collaborate, and succeed with the world's top freelancers.`}
            </Text>
            <Box
