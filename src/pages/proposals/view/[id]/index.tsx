...
import { getProposalById } from 'apiSdk/proposals';
...
function ProposalViewPage() {
  ...
  const { data, error, isLoading, mutate } = useSWR<ProposalInterface>(
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('proposal', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/proposals/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              >
                ...
                <FormListItem label="Rate" text={data?.rate} />
